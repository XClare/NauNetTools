...
class _UAPool:
    __head_user_agent = ['Mozilla/5.0 (Windows NT 6.3; WOW64; Trident/7.0; rv:11.0) like Gecko',
    ...
    def get_random_ua(self):
        return self.__head_user_agent[random.randrange(0, len(self.__head_user_agent))]
